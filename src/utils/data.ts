...
export type Quest = { id:string; name:string; icon:string; category:string; xp:number; difficulty:string; progress:number; desc:string; heroBg:string; verify:'checklist'|'quiz'|'photo'; checklist?:string[] }
export const PLAYER = {
  name:'Aelindra', level:12, rank:'Iron Sage', totalXP:3450, xpInLevel:1150, xpToNextLevel:1700,
  streakDays:7, completionRate:89,
  attributes:{ Focus:{level:18,pct:78}, Discipline:{level:14,pct:62}, Creativity:{level:11,pct:45}, Energy:{level:16,pct:70}, Knowledge:{level:20,pct:88}, Resilience:{level:9,pct:38} },
  equipment:['Focus Blade (Rare)','Orb of Clarity (Epic)','Ring of Discipline (Epic)'],
  recentGains:['Knowledge +8 (Today)','Energy +5 (Yesterday)','Focus +12 (2 days ago)']
}
